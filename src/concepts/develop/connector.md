...
<img :src="$withBase('<img :src="$withBase('/assets/img/connector/image2.png')">
...
<img :src="$withBase('/assets/img/connector/image1.png)" />
...
<img :src="$withBase('/assets/img/connector/smtp1.png)" />
...
<img :src="$withBase('/assets/img/connector/pop31.png)" />
...
<img :src="$withBase('/assets/img/connector/imap1.png)" />
...
<img :src="$withBase('/assets/img/connector/github2.png)" />
...
<img :src="$withBase('/assets/img/connector/gmail2.png)" />
...
<img :src="$withBase('/assets/img/connector/gcalendar2.png)" />
...
<img :src="$withBase('/assets/img/connector/gsheets2.png)" />
...
<img :src="$withBase('/assets/img/connector/image3.png)" />
